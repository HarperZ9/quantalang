// ===============================================================================
// BUILDLANG CODE GENERATOR - WASM BACKEND
// ===============================================================================
...
impl WasmBackend {
    ...
    fn gen_module_header(&mut self, module: &MirModule) {
        self.emit_line(";; Generated by BuildLang Compiler");
    ...
    fn wasm_binop(&self, op: BinOp, ty: &MirType) -> String {
        ...
        match op {
            ...
            BinOp::Pow => {
                ...
                format!("call $__build_pow_{}", wasm_ty)
            }
        }
    }
    ...
    fn gen_wasi_helpers(&mut self) {
        ...
        self.emit_line("(func $__build_print (param $ptr i32) (param $len i32)");
        self.indent += 1;
        ...
        self.emit_line("(func $__build_println (param $ptr i32) (param $len i32)");
        self.indent += 1;
        self.emit_line("local.get $ptr");
        self.emit_line("local.get $len");
        self.emit_line("call $__build_print");
        ...
        self.emit_line("(func $__build_alloc (param $size i32) (result i32)");
        self.indent += 1;
        ...
        self.emit_line("(func $__build_free (param $ptr i32)");
        self.indent += 1;
        ...
        if self.bulk_memory {
            self.emit_line(
                "(func $__build_memcpy (param $dest i32) (param $src i32) (param $len i32)",
            );
            self.indent += 1;
        ...
        if self.bulk_memory {
            self.emit_line(
                "(func $__build_memset (param $dest i32) (param $val i32) (param $len i32)",
            );
            self.indent += 1;
            self.emit_line("local.get $dest");
        ...
        // Exit function
        self.emit_line("(func $__build_exit (param $code i32)");
        self.indent += 1;
        ...
        // Abort function
        self.emit_line("(func $__build_abort");
        self.indent += 1;
        ...
        // Get args count
        self.emit_line("(func $__build_args_count (result i32)");
        self.indent += 1;
        ...
        self.emit_line("(func $__build_time_now (result i64)");
        self.indent += 1;
        ...
        // Random bytes
        self.emit_line("(func $__build_random (param $buf i32) (param $len i32) (result i32)");
        self.indent += 1;
        ...
        // Stderr print
        self.emit_line("(func $__build_eprint (param $ptr i32) (param $len i32)");
        self.indent += 1;
        self.emit_line("(local $iov i32)");
        self.emit_line("(local $written i32)");
        self.emit_line("global.get $__heap_base");
...
mod tests {
    ...
    fn test_wasi_helpers() {
        ...
        assert!(output.contains("$__build_print"));
        assert!(output.contains("$__build_println"));
