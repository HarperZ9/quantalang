...
static void swap(int32_t[100]* arr, int32_t i, int32_t j);
static void insertion_sort(int32_t[100]* arr, int32_t len);
static void selection_sort(int32_t[100]* arr, int32_t len);
static void bubble_sort(int32_t[100]* arr, int32_t len);
static bool is_sorted(int32_t[100]* arr, int32_t len);
static int32_t binary_search(int32_t[100]* arr, int32_t len, int32_t target);
...
static void swap(int32_t[100]* arr, int32_t i, int32_t j) {
    ...
    memcpy(_3, &(arr[i]), sizeof(_3));
    memcpy(temp, _3, sizeof(temp));
    memcpy(_5, &(arr[j]), sizeof(_5));
    fflush(stdout);
    return;
}
...
bb1:
    _3 = (i < len);
    if (_3) goto bb2; else goto bb3;
bb2:
    memcpy(_4, &(arr[i]), sizeof(_4));
    memcpy(key, _4, sizeof(key));
    _6 = (i - 1);
    j = _6;
    goto bb4;
bb3:
...
bb4:
    _8 = (j < len);
    if (_8) goto bb5; else goto bb6;
bb5:
    memcpy(_9, &(arr[j]), sizeof(_9));
    memcpy(_10, &(arr[min_idx]), sizeof(_10));
    _11 = (_9 < _10);
...
bb9:
    ...
    goto bb4;
bb10:
    memcpy(_15, &(arr[i]), sizeof(_15));
    memcpy(temp, _15, sizeof(temp));
    memcpy(_17, &(arr[min_idx]), sizeof(_17));
    goto bb12;
bb11:
    goto bb12;
bb12:
...
bb5:
    memcpy(_9, &(arr[j]), sizeof(_9));
    _10 = (j + 1);
    memcpy(_11, &(arr[_10]), sizeof(_11));
    _12 = (_9 > _11);
    if (_12) goto bb7; else goto bb8;
bb6:
    _19 = (i + 1);
    i = _19;
    goto bb1;
bb7:
    memcpy(_13, &(arr[j]), sizeof(_13));
    memcpy(temp, _13, sizeof(temp));
    _15 = (j + 1);
    memcpy(_16, &(arr[_15]), sizeof(_16));
    goto bb9;
bb8:
    goto bb9;
bb9:
...
bb1:
    _4 = (len - 1);
    _5 = (i < _4);
    if (_5) goto bb2; else goto bb3;
bb2:
    memcpy(_6, &(arr[i]), sizeof(_6));
    _7 = (i + 1);
    memcpy(_8, &(arr[_7]), sizeof(_8));
    _9 = (_6 > _8);
    if (_9) goto bb4; else goto bb5;
bb3:
    fflush(stdout);
    return true;
bb4:
...
bb1:
    _7 = (low <= high);
    if (_7) goto bb2; else goto bb3;
bb2:
    _8 = (high - low);
    _9 = (_8 / 2);
    _10 = (low + _9);
    mid = _10;
    memcpy(_12, &(arr[mid]), sizeof(_12));
    _13 = (_12 == target);
    if (_13) goto bb4; else goto bb5;
bb3:
    fflush(stdout);
    return _20;
bb4:
...
bb5:
    goto bb6;
bb6:
    memcpy(_15, &(arr[mid]), sizeof(_15));
    _16 = (_15 < target);
    if (_16) goto bb8; else goto bb9;
bb7:
    goto bb6;
bb8:
    _17 = (mid + 1);
