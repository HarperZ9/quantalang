...
static int32_t count_ones(int32_t n);
static int32_t count_zeros(int32_t n);
static bool is_power_of_two(int32_t n);
static int32_t next_power_of_two(int32_t n);
static int32_t leading_zeros(int32_t n);
static int32_t rotate_left(int32_t value, int32_t shift);
static int32_t rotate_right(int32_t value, int32_t shift);
static int32_t bit_set(int32_t value, int32_t bit);
static int32_t bit_clear(int32_t value, int32_t bit);
static bool bit_test(int32_t value, int32_t bit);
static int32_t bit_toggle(int32_t value, int32_t bit);
