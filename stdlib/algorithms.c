...
static int32_t binary_search_vec(QuantaVecHandle data, int32_t target);
static int32_t vec_sum(QuantaVecHandle data);
static int32_t vec_min(QuantaVecHandle data);
static int32_t vec_max(QuantaVecHandle data);
static int32_t vec_count(QuantaVecHandle data, int32_t target);
static bool vec_contains(QuantaVecHandle data, int32_t target);
...
bb2:
    _8 = (low <= high);
    if (_8) goto bb3; else goto bb4;
bb3:
    _9 = (high - low);
    _10 = (_9 / 2);
    _11 = (low + _10);
    mid = _11;
    _13 = quanta_hvec_get_i32(data, mid);
    goto bb5;
bb4:
    fflush(stdout);
    return _21;
...
bb8:
    _17 = (val < target);
    if (_17) goto bb10; else goto bb11;
bb9:
    goto bb8;
bb10:
    _18 = (mid + 1);
...
bb2:
    _6 = (i < len);
    if (_6) goto bb3; else goto bb4;
bb3:
    _7 = quanta_hvec_get_i32(data, i);
    goto bb5;
bb4:
    fflush(stdout);
    return total;
...
bb7:
    _9 = (i < len);
    if (_9) goto bb8; else goto bb9;
bb8:
    _10 = quanta_hvec_get_i32(data, i);
    goto bb10;
bb9:
    fflush(stdout);
    return result;
bb10:
    val = _10;
    _12 = (val < result);
    if (_12) goto bb11; else goto bb12;
bb11:
    result = val;
    goto bb13;
bb12:
...
bb2:
    _7 = (i < len);
    if (_7) goto bb3; else goto bb4;
bb3:
    _8 = quanta_hvec_get_i32(data, i);
    goto bb5;
bb4:
    fflush(stdout);
    return count;
