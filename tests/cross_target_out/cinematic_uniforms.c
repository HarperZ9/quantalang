...
const double softness = 0.6;
const double grain_amount = 0.05;

// Forward declarations
double hash(void);
double vignette(void);
double film_grain(void);
quanta_vec4 PS_Cinematic(void);
static double hash(double n);
static double vignette(double uv_x, double uv_y);
static double film_grain(double uv_x, double uv_y, double seed);
static quanta_vec4 PS_Cinematic(quanta_vec2 uv);
...
bb1:
    dist = _10;
    _12 = (0.5 * softness);
    _13 = quanta_smoothstep(0.5, _12, dist);
    goto bb2;
bb2:
    vig = _13;
    _15 = (1 - vig);
