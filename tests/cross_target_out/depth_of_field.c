...
// Type definitions
// Global variables
const double focus_distance = 0.3;
const double aperture = 0.01;

// Forward declarations
double circle_of_confusion(void);
double blur_sample_r(void);
double blur_sample_g(void);
double blur_sample_b(void);
quanta_vec4 PS_DepthOfField(void);
static double circle_of_confusion(double depth);
static double blur_sample_r(double color_r, double uv_x, double uv_y, double coc);
static double blur_sample_g(double color_g, double uv_x, double uv_y, double coc);
static double blur_sample_b(double color_b, double uv_x, double uv_y, double coc);
static quanta_vec4 PS_DepthOfField(quanta_vec2 uv);
