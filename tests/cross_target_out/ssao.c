...
// Type definitions
// Global variables
const double ao_radius = 0.005;
const double ao_intensity = 2;
const double ao_bias = 0.001;
const double ao_samples = 16;

// Forward declarations
double hash(void);
double hash2(void);
double compute_ao(void);
quanta_vec4 PS_SSAO(void);
static double hash(double n);
static double hash2(double a, double b);
static double compute_ao(double uv_x, double uv_y);
static quanta_vec4 PS_SSAO(quanta_vec2 uv);
...
bb11:
    ...
    _28 = (uv_y + _27);
    sample_y = _28;
    _30 = (quanta_vec2){ sample_x, sample_y };
    _31 = tex2d_depth(_30);
    goto bb12;
bb12:
    sample_depth = _31;
    ...
    diff = _33;
    _35 = (diff > ao_bias);
    if (_35) goto bb13; else goto bb14;
bb13:
    _36 = fabs(diff);
    goto bb16;
bb14:
