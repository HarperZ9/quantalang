...
double extract_bright_r(void);
double extract_bright_g(void);
double extract_bright_b(void);
double gaussian_weight(void);
double blur_channel_x(void);
double blur_channel_y(void);
double blur_channel_z(void);
quanta_vec4 PS_Bloom(void);
static double luminance(double r, double g, double b);
static double extract_bright_r(double r, double g, double b);
static double extract_bright_g(double r, double g, double b);
static double extract_bright_b(double r, double g, double b);
static double gaussian_weight(double offset);
static double blur_channel_x(double uv_x, double uv_y, double texel);
static double blur_channel_y(double uv_x, double uv_y, double texel);
static double blur_channel_z(double uv_x, double uv_y, double texel);
static quanta_vec4 PS_Bloom(quanta_vec2 uv);
...
bb1:
    lum = _4;
    _6 = (threshold + 0.1);
    _7 = quanta_smoothstep(threshold, _6, lum);
    goto bb2;
bb2:
    brightness = _7;
    _9 = (r * brightness);
...
static double blur_channel_x(double uv_x, double uv_y, double texel) {
    ...
    _4 = gaussian_weight(0);
    goto bb1;
bb1:
    w0 = _4;
    _6 = gaussian_weight(1);
    goto bb2;
bb2:
    w1 = _6;
    _8 = gaussian_weight(2);
    goto bb3;
bb3:
    w2 = _8;
    _10 = gaussian_weight(3);
    goto bb4;
bb4:
    w3 = _10;
    _12 = gaussian_weight(4);
    goto bb5;
bb5:
    w4 = _12;
    _14 = (quanta_vec2){ uv_x, uv_y };
    _15 = tex2d(_14);
    goto bb6;
bb6:
    c0 = _15;
    _17 = (uv_x + texel);
    _18 = (quanta_vec2){ _17, uv_y };
    _19 = tex2d(_18);
    goto bb7;
bb7:
    c1p = _19;
    _21 = (uv_x - texel);
    _22 = (quanta_vec2){ _21, uv_y };
    _23 = tex2d(_22);
    goto bb8;
bb8:
    c1n = _23;
...
bb9:
    ...
    _30 = (texel * 2);
    _31 = (uv_x - _30);
    _32 = (quanta_vec2){ _31, uv_y };
    _33 = tex2d(_32);
    goto bb10;
bb10:
    c2n = _33;
    _35 = (uv_y + texel);
    _36 = (quanta_vec2){ uv_x, _35 };
    _37 = tex2d(_36);
    goto bb11;
bb11:
    c3p = _37;
    _39 = (uv_y - texel);
    _40 = (quanta_vec2){ uv_x, _39 };
    _41 = tex2d(_40);
    goto bb12;
bb12:
    c3n = _41;
...
bb7:
    ...
    _41 = (_39 + _40);
    b = _41;
    _43 = quanta_clampf(r, 0, 1);
    goto bb8;
bb8:
    _44 = quanta_clampf(g, 0, 1);
    goto bb9;
bb9:
    _45 = quanta_clampf(b, 0, 1);
    goto bb10;
bb10:
    _46 = (quanta_vec4){ _43, _44, _45, 1 };
    return _46;
}
