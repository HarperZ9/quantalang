...
// Type definitions
// Global variables
const double blur_radius = 3;
const double blur_strength = 1;

// Forward declarations
double gaussian_weight(void);
double blur_horizontal(void);
quanta_vec4 PS_Blur(void);
static double gaussian_weight(double offset, double sigma);
static double blur_horizontal(double uv_x, double uv_y, double pixel_w);
static quanta_vec4 PS_Blur(quanta_vec2 uv);
...
bb2:
    blurred = _6;
    _8 = (quanta_vec4){ blurred, blurred, blurred, 1 };
    return _8;
}
