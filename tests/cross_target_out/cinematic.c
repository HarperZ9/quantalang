...
// Type definitions
// String table
static const char* __str0 = "cinematic: %g\n";

// Forward declarations
double hash(void);
double vignette(void);
double film_grain(void);
double lift_gamma_gain(void);
double srgb_to_linear(void);
double linear_to_srgb(void);
double process_pixel(void);
static double hash(double n);
static double vignette(double uv_x, double uv_y, double strength, double softness);
static double film_grain(double uv_x, double uv_y, double seed, double amount);
static double lift_gamma_gain(double c, double lift, double gamma, double gain);
static double srgb_to_linear(double c);
static double linear_to_srgb(double c);
static double process_pixel(double r, double g, double b, double uv_x, double uv_y, double time);
int32_t main(void);
...
bb1:
    dist = _12;
    _14 = (0.5 * softness);
    _15 = quanta_smoothstep(0.5, _14, dist);
    goto bb2;
bb2:
    vig = _15;
    _17 = (1 - vig);
...
int32_t main(void) {
    ...
    _1 = process_pixel(0.7, 0.5, 0.3, 0.5, 0.5, 0);
    goto bb1;
bb1:
    result = _1;
    _3 = __str0;
