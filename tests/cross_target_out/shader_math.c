...
double fog_factor(void);
quanta_vec4 fs_main(void);
static double fresnel_schlick(double cos_theta, double f0);
static double fog_factor(double distance, double density);
static quanta_vec4 fs_main(quanta_vec3 uv);
...
bb8:
    fog = _27;
    _29 = (quanta_vec4){ brightness, fresnel, fog, 1 };
    return _29;
}
