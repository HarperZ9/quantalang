...
// Type definitions
// Global variables
const double edge_threshold = 0.001;
const double edge_intensity = 5;
const double outline_only = 0;

// Forward declarations
double sample_depth(void);
double sobel_edge(void);
quanta_vec4 PS_EdgeDetect(void);
static double sample_depth(double uv_x, double uv_y);
static double sobel_edge(double uv_x, double uv_y, double texel);
static quanta_vec4 PS_EdgeDetect(quanta_vec2 uv);
...
bb2:
    ...
    edge = _7;
    _9 = (edge_threshold * 2);
    _10 = quanta_smoothstep(edge_threshold, _9, edge);
    goto bb3;
bb3:
    mask = _10;
    _12 = color.x;
