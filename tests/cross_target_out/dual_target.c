...
// Type definitions
// String table
static const char* __str0 = "=== QuantaLang Dual-Target Proof ===\n";
...
double fresnel(void);
quanta_vec4 fs_postprocess(void);
static double aces_tonemap(double x);
static double fresnel(double cos_theta, double f0);
static quanta_vec4 fs_postprocess(quanta_vec3 hdr_color);
int32_t main(void);
