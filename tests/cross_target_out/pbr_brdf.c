...
double pi(void);
double fresnel_schlick(void);
double distribution_ggx(void);
double geometry_schlick_ggx(void);
double geometry_smith(void);
double cook_torrance_specular(void);
double pbr_lighting(void);
double aces_tonemap(void);
double linear_to_srgb(void);
quanta_vec4 fs_pbr(void);
