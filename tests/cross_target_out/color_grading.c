...
double apply_saturation(void);
double apply_temperature(void);
quanta_vec4 PS_ColorGrade(void);
static double srgb_to_linear(double c);
static double linear_to_srgb(double c);
static double lift_gamma_gain(double c);
static double apply_saturation(double r, double g, double b);
static double apply_temperature(double r, double b);
static quanta_vec4 PS_ColorGrade(quanta_vec2 uv);
