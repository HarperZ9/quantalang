...
double compute_diffuse(void);
quanta_vec4 fs_main(void);
static double compute_diffuse(double normal_x, double normal_y, double normal_z, double light_x, double light_y, double light_z);
static quanta_vec4 fs_main(quanta_vec3 color);
...
static quanta_vec4 fs_main(quanta_vec3 color) {
    ...
    _2 = compute_diffuse(0, 1, 0, 0.577, 0.577, 0.577);
    goto bb1;
bb1:
    diffuse = _2;
    _4 = color.x;
