...
// Type definitions
// String table
static const char* __str0 = ".";
static const char* __str1 = "Files in current dir: %lld\n";
static const char* __str2 = "  %s\n";
...
int32_t main(int argc, char** argv) {
    ...
    _1 = quanta_args_count();
    goto bb1;
bb1:
    nargs = _1;
    _3 = quanta_string_new(__str0);
    goto bb2;
bb2:
    path_4 = _3;
    _5 = (nargs > 1);
    if (_5) goto bb3; else goto bb4;
bb3:
    _6 = quanta_args_get(1);
    goto bb6;
bb4:
    goto bb5;
bb5:
...
bb10:
    _16 = (i < count);
    if (_16) goto bb11; else goto bb12;
bb11:
    _17 = quanta_hvec_get_str(files, i);
    goto bb13;
bb12:
    fflush(stdout);
    return 0;
