...
// String table
static const char* __str0 = "Uniform buffer test:\n";
static const char* __str1 = "Camera FOV: %g\n";
static const char* __str2 = "Camera aspect: %g\n";
static const char* __str3 = "V1 transform: positive (correct)\n";
static const char* __str4 = "V1 transform: negative (wrong)\n";
static const char* __str5 = "V2 transform: positive (correct)\n";
static const char* __str6 = "V2 transform: negative (wrong)\n";
static const char* __str7 = "V3 transform: negative (correct)\n";
static const char* __str8 = "V3 transform: positive (wrong)\n";
static const char* __str9 = "Near/far valid: yes\n";
static const char* __str10 = "Near/far valid: no\n";
static const char* __str11 = "Uniform buffer test complete\n";

// Forward declarations
static double transform_vertex(double pos_x, double pos_y, double pos_z, double scale);
static double apply_mvp(double x, double y, double z, CameraData cam);
...
static double apply_mvp(double x, double y, double z, CameraData cam) {
    ...
    _6 = (1 / _5);
    scale = _6;
    _8 = transform_vertex(x, y, z, scale);
    goto bb1;
bb1:
    projected = _8;
    _10 = cam.aspect;
...
int32_t main(int argc, char** argv) {
    ...
    _1 = (CameraData){ 1.5708, 1.7778, 0.1, 100 };
    camera = _1;
    _3 = apply_mvp(1, 0, 0, camera);
    goto bb1;
bb1:
    v1 = _3;
    _5 = apply_mvp(0.5, 1, 2, camera);
    goto bb2;
bb2:
    v2 = _5;
    _7 = apply_mvp(-0.5, -0.5, 1, camera);
    goto bb3;
bb3:
    v3 = _7;
    _9 = __str0;
...
bb9:
    _18 = (v2 > 0);
    if (_18) goto bb12; else goto bb13;
bb10:
    goto bb9;
bb11:
    goto bb9;
...
bb14:
    _22 = (v3 < 0);
    if (_22) goto bb17; else goto bb18;
bb15:
    goto bb14;
bb16:
    goto bb14;
...
bb19:
    ...
    _27 = camera.far;
    _28 = (_26 < _27);
    if (_28) goto bb22; else goto bb23;
bb20:
    goto bb19;
bb21:
    goto bb19;
