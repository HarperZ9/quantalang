...
// Vtable: Rectangle implements Shape
static Shape_vtable Rectangle_Shape_vtable_instance = {
    .area = (double (*)(void*))Rectangle_area,
    .name = (int32_t (*)(void*))Rectangle_name,
};

// Vtable: Circle implements Shape
static Shape_vtable Circle_Shape_vtable_instance = {
    .area = (double (*)(void*))Circle_area,
    .name = (int32_t (*)(void*))Circle_name,
};
